            ...
            <Card>
              <Card.Header>
                ...
                <p className="text-muted">
                  ...
                  <code>printing and typesetting</code> industry. Lorem Ipsum
                ...
                <Form method="get" action className="form-horizontal">
                  ...
                  <Form.Group>
                    ...
                    <small className="text-muted">
                      Sample : <code>corporate-page</code>
                    </small>
                  </Form.Group>
                  <Form.Group>
                    <label>Content</label>
                  ...
                  <div className>
                    ...
                    <p className="text-muted">
                      Lorem Ipsum is simply dummy text of the{" "}
                      <code>printing and typesetting</code> industry. Lorem
                  ...
                  <Form.Group>
                    ...
                    />
                    <small className="text-muted">
                      Sample : <code>apple, pear, banana, wholesale</code>
                    </small>
                  </Form.Group>
                  <Form.Group>
