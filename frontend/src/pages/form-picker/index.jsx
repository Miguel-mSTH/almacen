    ...
    return (
      <React.Fragment>
        <Row>
          <Col md="12">
            <Card>
              <Card.Header>Date Range Picker</Card.Header>
              <Card.Body>
                <Row>
                  <Col md="6">
                    <h5>
                ...
                <Row>
                  <Col md="6">
                    <h5>
                      <small>Single Date Picker</small>
                    </h5>
                    <Form.Group>
                      <InputGroup className="m-b">
                  ...
                  <Col md="6">
                    <h5>
                      <small>Input Initially Empty</small>
                    </h5>
                    <Form.Group>
                      <InputGroup className="m-b">
                        <span className="input-group-addon">
        ...
        <Row>
          <Col md="12">
            <Card>
              <Card.Header>Clock Picker</Card.Header>
              <Card.Body>
                <Row>
                  <Col md="6">
                    <h5>
                ...
                <Row>
                  <Col md="6">
                    <h5>
                      <small>
                        Set options in javascript, instead of{" "}
                        <code>data-*</code>
                      </small>
                    </h5>
                    <Form.Group>
                  ...
                  <Col md="6">
                    <h5>
                      <small>
                        Set default value, input without addon, and manual
                        operations
                      </small>
                    </h5>
                    <Form.Group>
                ...
                <Row>
                  <Col md="6">
                    ...
                    <Form.Group>
                      <input
                        className="form-control clockpicker-with-callbacks"
                        id="single-input"
                        defaultValue
                        placeholder="Now"
                      />
